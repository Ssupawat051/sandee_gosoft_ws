...
if (moveL>0.0){
        analogWrite(6,max(min(moveL*100,128),65));
        digitalWrite(7,0);
    }else if (moveL<0.0){
        analogWrite(6,max(min(abs(moveL)*100,128),65));
        digitalWrite(7,1);
    }else{ 
        analogWrite(6,0);
        digitalWrite(7,0);
...
if (moveR>0.0){
        analogWrite(44,max(min(moveR*100,128),65));
        digitalWrite(45,0);
    }else if (moveR<0.0){
        analogWrite(44,max(min(abs(moveR)*100,128),65));
        digitalWrite(45,1);
    }else{ 
        analogWrite(44,0);
        digitalWrite(45,0);
